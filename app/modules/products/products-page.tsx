...
import SearchBar from "@/lib/components/complex/search-bar";
import Order from "@/lib/components/complex/order";
import MainLayout from "@/lib/components/complex/main-layout";
import Paginator from "@/lib/components/complex/paginator";
import { initializeStore } from "@/ducks/index";
import useObserveQueryParam from "@/lib/hooks/use-observe-query-param";
import {
  fetchProductsByAC,
